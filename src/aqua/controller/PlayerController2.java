...
public class PlayerController2 implements InputProviderListener {
	...
	public PlayerController2(GameContainer container, Game game, Player player) {
...
//		provider.bindCommand(new KeyControl(Input.KEY_RIGHT), right);
		...
		provider.bindCommand(new MouseButtonControl(1), cord);
	}
